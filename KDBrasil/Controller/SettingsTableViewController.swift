...
class SettingsTableViewController: UITableViewController {
    ...
    let nameMenu:[String] = [NSLocalizedString(LocalizationKeys.settingsAccount, comment: ""),
                             NSLocalizedString(LocalizationKeys.settingsShare, comment: ""),
                             NSLocalizedString(LocalizationKeys.settingsContactUs, comment: ""),
                             NSLocalizedString(LocalizationKeys.settingsTermsOfUse, comment: ""),
